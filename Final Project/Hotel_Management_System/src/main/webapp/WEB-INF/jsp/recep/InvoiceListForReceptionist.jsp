<%-- 
    Document   : InvoiceListForReceptionist
    Created on : Aug 29, 2020, 8:02:49 PM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>Invoice list for Receptionist</title>
...
<!--                                            <form action="/invoice/saveInvoice/" method="post">
                                            ...
                                            <a href="/invoice/deleteFromReceptionist/${doc.id}" style="color: red">
