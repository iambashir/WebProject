<%-- 
    ...
    Created on : Aug 21, 2020, 6:28:06 PM
    Author     : Asus
--%>
...
<!--        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="col-md-6">
                    ...
                    <div> <h4>First Name : </h4></div><br>
                    
                    <div> <h4>Last Name : </h4></div><br>
    ...
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">Admin</h4>
                <p class="m-b-sm">${u.firstname} ${u.lastname}</p>
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="value">
                                        <div class="m-b-5">
                                            <b>Administator</b> <a href="#" class="m-l-10">Edit</a><br />
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        Dhaka <a href="#" class="m-l-10">Edit</a><br />
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">Administator of MEDICIO HOSPITAL</div>
                    </li>
                    <li>
                        <div class="field">Qualification:</div>
                        <div class="value">MBBS, BCS, FCPS </div>
                    </li>
                    <li>
                        <div class="field">Birth of Date:</div>
                        <div class="value">1993/01/01</div>
                    </li>
                    <li>
