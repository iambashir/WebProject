...
<!--            End nav-->
        ...
        <div class="row">
         ...
         <div style="text-align: center"><h1 style="color: #008CBA">Search User</h1><br></div>
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="col-md-4">
                    ...
                    <h1 style="color: #008CBA">List of Users</h1>
...
<!--                                  <th style="color: #0056b3">Password</th>-->
                        ...
                        <tbody>
                        <c:forEach items="${userList}" var="doc">
                            <tr>
...
<!--                                <td style="color: #777777">${doc.password}</td>-->
                                ...
                                <td>
                                    <a href="/user/edit/${doc.id}" style="color: blue">
                                    <i class='fas fa-edit' style='font-size:30px;color:#194b4d'></i>
                                    </a>
                                    
                                    
                                    <a href="/user/delete/${doc.id}" style="color: red">
