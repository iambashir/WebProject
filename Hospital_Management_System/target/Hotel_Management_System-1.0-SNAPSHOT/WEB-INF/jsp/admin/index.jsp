...
<!--  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-between">-->
                        ...
                        <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-8" style="background: beige">
                                <h3 style="color: darkolivegreen"> Call us now : +1558 5548 557 , Email: mediciohospitl@gmail.com</h3>
                            </div>
<!--                        <div class="col-md-4"> 
                         <h3>,01723568958 Email: mediciohospitl@gmail.com</h3>   
                     
                        </div>-->
  
                       
                        <div class="col-md-4" style="background: beige">
                            
                            <div style="text-align: right">
                    <h3 style="color: darkolivegreen"> Monday - Saturday, 8AM to 10PM</h3>
                        ...
                        <a href="index.html" class="logo mr-auto"><img src="assets/img/logo.png" width="190" height="60" alt=""></a>
                        <a href="/appoin/TempletApoin" class="appointment-btn scrollto"><span class="d-none d-md-inline">Request for an</span> Appointment</a><span></span>
<!--                        <a href="/index.html"><i class="fa fa-hospital-o" style="font-size:48px;color:red"></i></a>-->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                  <a href="/appoin/TempletApoin"> <img src="assets/img/doctors/doctors-1.jpg" class="img-fluid" alt="" width="300" height="350"></a>
                <div class="social">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                 <a href="/appoin/TempletApoin"><img src="assets/img/doctors/doctors-2.jpg" class="img-fluid" alt="" width="300" height="350"></a>
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <a href="/appoin/TempletApoin"><img src="assets/img/doctors/doctors-3.jpg" class="img-fluid" alt="" width="300" height="350"></a>
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <a href="/appoin/TempletApoin"><img src="assets/img/doctors/doctors-4.jpg" class="img-fluid" alt="" width="300" height="350"></a>
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a>
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <a class="cta-btn scrollto" href="/appoin/TempletApoin">Request for Make an Appointment</a>
        </div>
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="col-md-8">
                    ...
                    <form action="/AppoinSave" method="post">
              ...
              <select class="form-control" id="department" name="department">
                ...
                <option value="Dr. Mahbub Mansur">Dr. Mahbub Mansur</option>
                <option value="Prof. Dr. Sudhakar Chandran Bose">Prof. Dr. Sudhakar Chandran Bose</option>
                ...
                <option value="Dr. M. A. Wahab Khan">Dr. M. A. Wahab Khan</option>
                <option value="Dr. Mosaddeque Ahmed">Dr. Mosaddeque Ahmed</option>
                        ...
                        <button type="submit" class="btn btn-default">Add Doctor</button>
                         ...
                         <input type="submit" class="btn btn-success" value="Save an Appointment">
...
<!--        <form action="/appoin/save" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">-->
          ...
          <div class="form-row">
            <div class="col-md-4 form-group">
              ...
              <div class="validate"></div>
               ...
               <div class="col-md-4 form-group">
              <input type="time" name="time" class="form-control datepicker" id="time" placeholder="Appointment Time" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
              
               <div class="col-md-4 form-group">
              <input type="text" name="firstname" class="form-control" id="firstname" placeholder="Your First Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            ...
            <div class="form-group">
                 ...
                 <div class="col-md-4 form-group">
              <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Your Last Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="assets/img/doctors/doctors-1.jpg" class="img-fluid" alt="" width="300" height="350">
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="assets/img/doctors/doctors-2.jpg" class="img-fluid" alt="" width="300" height="350">
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <img src="assets/img/doctors/doctors-3.jpg" class="img-fluid" alt="" width="300" height="350">
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <img src="assets/img/doctors/doctors-4.jpg" class="img-fluid" alt="" width="300" height="350">
                <div class="social">
                  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a>
