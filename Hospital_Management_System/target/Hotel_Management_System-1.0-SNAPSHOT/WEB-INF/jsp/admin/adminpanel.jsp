<%-- 
    Document   : adminpanel
    Created on : Aug 8, 2020, 9:10:50 PM
    Author     : Asus
--%>
...
<div style="text-align:center">
  <h2 style="color: darkolivegreen">Image Gallery</h2>
...
<div class="row">
  <div class="column">
    <img src="/assets/test/gallery-1.jpg" alt="Nature" style="width:100%" onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="/assets/test/gallery-3.jpg" alt="Snow" style="width:100%" onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="/assets/test/gallery-4.jpg" alt="Mountains" style="width:100%" onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="/assets/test/gallery-7.jpg" alt="Lights" style="width:100%" onclick="myFunction(this);">
  </div>
</div>
