<%-- 
    ...
    Created on : Aug 23, 2020, 7:49:47 PM
    Author     : Asus
--%>
...
<!--        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="col-md-6">
                    ...
                    <h1 style="color: #444444">Profile</h1>
                    <h3 style="color: #ed3c0d">----------------------------------</h3>
                    </div>
                    <span></span><br>
                    
                    <div> <h4>First Name : Nazrul</h4></div><br>
                    
                    <div> <h4>Last Name : Islam</h4></div><br>
                    
                    <div> <h4>User Name : </h4></div><br>
                    
                    <div> <h4>Email : </h4></div><br>
                    
                    <div> <h4>Password : </h4></div><br>
                    
                    <div> <h4>Mobile Number : </h4></div><br>
                    
                    <div> <h4>Address : </h4></div><br>
    ...
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">Doctor</h4>
                <p class="m-b-sm">${doc.firstname} ${doc.lastname}</p>
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="value">
                                        <div class="m-b-5">
                                            <b>MEDICIO HOSPITAL</b> <a href="#" class="m-l-10">Edit</a><br />
                                            <span class="text-muted">Specialist : ${doc.specialization}</span><br>
                                            <span class="text-muted">${doc.qualification}</span>
                                        </div>
<!--                                        <div>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        Specialist of Health & ${doc.specialization}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table class="table table-profile">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        ${doc.address} <a href="#" class="m-l-10">Edit</a><br />
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">Specialist of Health & ${doc.specialization}</div>
                    </li>
                    <li>
